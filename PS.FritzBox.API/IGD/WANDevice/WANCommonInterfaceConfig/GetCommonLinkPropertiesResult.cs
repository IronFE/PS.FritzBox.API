...
namespace PS.FritzBox.API.IGD.WANDevice.WANCommonInterfaceConfig
{
    ...
    public class GetCommonLinkPropertiesResult
    {
        ...
        {
            this.WANAccessType = (WANAccessType)Enum.Parse(typeof(WANAccessType), soapresult.Descendants("NewWANAccessType").First().Value);
            ...
            this.PhysicalLinkStatus = (PhysicalLinkStatus)Enum.Parse(typeof(PhysicalLinkStatus), soapresult.Descendants("NewPhysicalLinkStatus").First().Value);
        }
