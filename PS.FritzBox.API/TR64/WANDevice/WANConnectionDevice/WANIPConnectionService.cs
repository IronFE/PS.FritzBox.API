...
namespace PS.FritzBox.API.TR64.WANDevice.WANConnectionDevice
{
    ...
    /// </summary>
    public class WANIPConnectionService : FritzServiceBase, IWANConnectionService
    {
        ...
        public async Task<GetWANConnectionInfoResult> GetInfoAsync()
        {
            XDocument soapResult = await base.InvokeAsync("GetInfo", null);
            return new GetWANConnectionInfoResult(soapResult);
        }
