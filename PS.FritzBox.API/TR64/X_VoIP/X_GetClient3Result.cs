...
{
    /// <summary>
    /// result object for X_GetClient3
    /// </summary>
    public class X_GetClient3Result
    {
        ...
        /// </summary>	    
        internal X_GetClient3Result(XDocument soapresult)
        {
            ...
            this.InComingNumbers = soapresult.Descendants("NewX_AVM-DE_InComingNumbers").First().Value;
            this.ExternalRegistration = soapresult.Descendants("NewX_AVM-DE_ExternalRegistration").First().Value == "1";
        }
        ...
        /// </summary>
        public string InComingNumbers { get; internal set;}

        /// <summary>
        /// gets or sets the ExternalRegistration
        /// </summary>
        public bool ExternalRegistration { get; internal set;}
