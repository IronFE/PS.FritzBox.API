...
{
    /// <summary>
    /// client proxy class for X_WebDAVClient service
    /// </summary>
    public class X_WebDAVClientService : FritzServiceBase
    {
        #region Construction / Destruction

        /// <summary>
        /// constructor for X_WebDAVClientService
        /// </summary>
        /// <param name="url">the service url</param>
        /// <param name="timeout">the timeout in milliseconds</param>
        public X_WebDAVClientService(string url, int timeout) : base(url, timeout)
        {
        }
        ...
        public X_WebDAVClientService(string url, int timeout, string username) : this(url, timeout)
        {
        ...
        public X_WebDAVClientService(string url, int timeout, string username, string password) : this(url, timeout, username)
        {
        ...
        public X_WebDAVClientService(ConnectionSettings connectionSettings) : base(connectionSettings)
        {
        ...
        /// </summary>
        protected override string ControlUrl => "/upnp/control/x_webdav";

        /// <summary>
        /// gets the request namespace
        /// </summary>
        protected override string RequestNameSpace => "urn:dslforum-org:service:X_AVM-DE_WebDAVClient:1";
        ...
        public async Task SetConfigAsync(SetConfigRequest request)
        {
            List<SOAP.SoapRequestParameter> parameters = new List<SOAP.SoapRequestParameter>()
            {
                ...
                new SOAP.SoapRequestParameter("NewHostURL", request.HostURL.ToString()),
                ...
                new SOAP.SoapRequestParameter("NewMountpointName", request.MountpointName.ToString())
            };
