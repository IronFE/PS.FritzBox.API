...
{
    /// <summary>
    /// result object for GetGenericAssociatedDeviceInfo
    /// </summary>
    public class GetGenericAssociatedDeviceInfoResult
    {
        ...
        /// </summary>	    
        internal GetGenericAssociatedDeviceInfoResult(XDocument soapresult)
        {
            this.AssociatedDeviceMACAddress = soapresult.Descendants("NewAssociatedDeviceMACAddress").First().Value;
        ...
        /// </summary>
        public string AssociatedDeviceMACAddress { get; internal set;}
